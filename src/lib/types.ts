...
export interface ResumeVersion { id: string; name: string; isAI: boolean; isBase?: boolean; matchScore?: number; jobTitle?: string; jobCompany?: string; jobDescription?: string; jobLink?: string; baseResumeId?: string; jdVariantId?: string; variantContent?: string; lastCurationInputHash?: string; shareSlug?: string; data: ResumeData; aiChanges: AIChange[]; }
